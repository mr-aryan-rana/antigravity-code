...
class Superblock {
    ...
    constructor(opts = {}) {
        ...
        this.link = (filename1, filename2) => {
            ...
            this.emit(new FsEvent_1.FsEvent(0 /* FsEventType.CREATE */, newLink.steps, node));
        };
        ...
        this.symlink = (targetFilename, pathFilename) => {
            ...
            this.emit(new FsEvent_1.FsEvent(0 /* FsEventType.CREATE */, symlink.steps, symlink.getNode()));
            return symlink;
        };
        this.rename = (oldPathFilename, newPathFilename) => {
            ...
            this.emit(new FsEvent_1.FsEvent(3 /* FsEventType.MOVE */, link.steps, link.getNode(), oldSteps));
        };
        this.mkdir = (filename, modeNum) => {
            ...
            this.emit(new FsEvent_1.FsEvent(0 /* FsEventType.CREATE */, child.steps, child.getNode()));
        };
        /**
        ...
        this.mkdirp = (filename, modeNum) => {
            ...
            for (i; i < steps.length; i++) {
                ...
                this.emit(new FsEvent_1.FsEvent(0 /* FsEventType.CREATE */, curr.steps, curr.getNode()));
            }
        ...
        this.ftruncate = (fd, len) => {
            ...
            file.truncate(len);
            this.emit(new FsEvent_1.FsEvent(2 /* FsEventType.MODIFY */, file.link.steps, file.node));
        };
        ...
        this.chmod = (filename, modeNum) => {
            ...
            this.emit(new FsEvent_1.FsEvent(2 /* FsEventType.MODIFY */, link.steps, link.getNode()));
        };
        ...
        this.utimes = (filename, atime, mtime, followSymlinks = true) => {
            ...
            node.atime = new Date(atime * 1000);
            node.mtime = new Date(mtime * 1000);
            this.emit(new FsEvent_1.FsEvent(2 /* FsEventType.MODIFY */, link.steps, node));
        };
    ...
    _emitDeleteRecursive(link) {
        ...
        this.emit(new FsEvent_1.FsEvent(1 /* FsEventType.DELETE */, link.steps, link.getNode()));
    }
    newInoNumber() {
    ...
    openFile(filename, flagsNum, modeNum, resolveSymlinks = true) {
        ...
        try {
            ...
            if (err.code === "ENOENT" /* ERROR_CODE.ENOENT */ && flagsNum & O_CREAT) {
                ...
                this.emit(new FsEvent_1.FsEvent(0 /* FsEventType.CREATE */, link.steps, link.getNode()));
            }
            else
                throw err;
        }
